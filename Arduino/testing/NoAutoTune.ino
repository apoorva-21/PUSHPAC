...
double OPT_STICK_CORRECTION_FACTOR = 1;
...
double aTuneStep = 0;//the output corrections to make when the bot is autotuning
...
void readController()
{
  rightStickHorizontal = constrainValue(1000, -1000, mapValue(pulseIn(CH_1, HIGH) - RIGHT_STICK_HORIZONTAL_LEFT, RIGHT_STICK_HORIZONTAL_LEFT, RIGHT_STICK_HORIZONTAL_RIGHT, -1000, 1000));
  rightStickVertical = constrainValue(1000, -1000, mapValue((pulseIn(CH_2, HIGH) - RIGHT_STICK_VERTICAL_DOWN - 15), RIGHT_STICK_VERTICAL_DOWN, RIGHT_STICK_VERTICAL_UP, -1000, 1000));
  leftStickVertical = constrainValue(2000, 1000, mapValue((pulseIn(CH_3, HIGH) - LEFT_STICK_VERTICAL_DOWN - 15) , LEFT_STICK_VERTICAL_DOWN, LEFT_STICK_VERTICAL_UP, 2000, 1000));
  leftStickHorizontal = constrainValue(1000, -1000, mapValue(pulseIn(CH_4, HIGH) - LEFT_STICK_HORIZONTAL_LEFT, LEFT_STICK_HORIZONTAL_LEFT, LEFT_STICK_HORIZONTAL_RIGHT, -1000, 1000));
